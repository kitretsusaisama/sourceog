export declare const SOURCEOG_MANIFEST_VERSION = "2027.1";
...
export declare function createDiagnosticsEnvelope(issues?: DiagnosticIssue[], buildId?: string): DiagnosticsEnvelope;
...
export type ParitySubsystemId = "rendering" | "routing" | "server-client-boundary" | "server-actions" | "cache" | "compiler" | "dev-runtime" | "platform" | "deployment" | "migration-dx";
export type ParityBlockerCategory = "rendering" | "routing" | "boundary" | "actions" | "cache" | "compiler" | "dev-runtime" | "platform" | "deployment" | "migration-dx";
