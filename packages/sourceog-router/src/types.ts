// packages/sourceog-router/src/types.ts
import type { DiagnosticsEnvelope } from "@sourceog/runtime";

// ---------------------------------------------------------------------------
// Design-doc types (RouteTree, RouteNode, RouteMatch, etc.)
// ---------------------------------------------------------------------------
...
export type RouteSegmentSemanticKind =
  | "static"
  | "dynamic"
  | "catchall"
  | "optional-catchall"
...
// ---------------------------------------------------------------------------
// Optional helper aliases for runtime consumers
// ---------------------------------------------------------------------------
