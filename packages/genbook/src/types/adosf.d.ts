...
export type FallbackStage = "full-stream" | "incremental-stream" | "hybrid-cache" | "cache-serve" | "shell-only" | "typed-error";
export type SafetyProfile = "strict" | "balanced" | "latency-biased" | "resilience-biased";
export type RouteClass = "static" | "semi-static" | "auth-sensitive" | "mutation-heavy" | "latency-critical" | "edge-friendly" | "graph-hot";
export type TrafficSegment = "anonymous" | "authenticated" | "bot" | "warm-cache" | "cold-cache" | "degraded-mode";
